		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
              ...
              <a href="{{route('user.view')}}" style="float:right;" class="btn btn-rounded btn-info mb-5">Back</a>
...
<div class="row">
	...
	<div class="controls">
	 <select name="user_type" id="user_type" value="{{$editData->user_type}}" required="" class="form-control">
			<option value="" selected="" disabled="">Select Role</option>
			<option value="Admin" {{ ($editData->user_type == "Admin" ? "selected" : "") }}>Admin</option>
			<option value="Operator" {{ ($editData->user_type == "Operator" ? "selected" : "") }}>Operator</option>
