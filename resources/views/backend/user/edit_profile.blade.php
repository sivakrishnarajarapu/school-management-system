		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
              ...
              <a href="{{route('profile.view')}}" style="float:right;" class="btn btn-rounded btn-info mb-5">Back</a>
...
<img id="showImage" src="{{ (!empty($editData->image)) ? url('uploads/user_images/'.$editData->image) : url('uploads/no_image.jpeg') }}" 
style="width:100px; width:100px; border:1px;">
